...
def move_to_zero_position(base, base_cyclic):
    ...
    or product.model == Base_pb2.ProductConfiguration__pb2.MODEL_ID_L31):
        if(product.model == Base_pb2.ProductConfiguration__pb2.MODEL_ID_L31):
            ...
            if(degreesOfFreedom.count == 6):
                ...
                jointPoses = (  ( 360.5,        35.6,       180.7,        281.8,                  0.8,   23.8,        88.9  ),
                                ( 300.4,        35.0,            90,          190,                   10,   24,          90),
                                ( 300.2,         34,             0,          100,                   20,   26,          100),
                                ( 200,         -85,           -90,           60,                   30,   27,          110),
                                (189.61798695, -107.50206064, -105.75168338, 56.61205292, 39.62597022,   29.70235836, 129.62050455), )
...
def main():
    ...
    with utilities.DeviceConnection.createTcpConnection(args) as router:
        ...
        success &= move_to_zero_position(base, base_cyclic)
